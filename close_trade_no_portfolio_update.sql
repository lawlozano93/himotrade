-- This function closes a trade without trying to update the portfolio's equity_value
CREATE OR REPLACE FUNCTION close_trade_no_portfolio(
  p_trade_id UUID,
...
BEGIN
  ...
  -- Special handling to disable triggers temporarily to prevent portfolio updates
  -- This prevents the error with missing equity_value column
...
GRANT EXECUTE ON FUNCTION close_trade_no_portfolio TO authenticated; 